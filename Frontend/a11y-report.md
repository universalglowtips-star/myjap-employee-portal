...
Dibuat: 2026-08-26T02:18:53.476Z
...
| Karyawan - Arsip | `/employees/archive` | Discan | 1 |
...
| Lokasi Kantor - Modal Edit (Tab Info) | `/office-locations` | Discan | 1 |
| Lokasi Kantor - Modal Edit (Tab Supervisor) | `/office-locations` | Discan | 1 |
| Komponen Gaji | `/payroll/salary-components` | Discan | 21 |
| Audit Log - List | `/audit-log` | Discan | 15 |
| Audit Log - Detail Modal | `/audit-log` | Discan | 0 |

**Total violation di seluruh halaman: 40**

## Dikelompokkan Berdasarkan Root Cause

Ditemukan 6 root cause unik. Untuk rule `color-contrast`, dikelompokkan berdasarkan pasangan warna foreground/background PERSIS (class Tailwind yang sama selalu hasilin pasangan warna yang sama, di halaman mana pun dia dipakai).

### 1. `color-contrast` - 22 kemunculan
...
- **Foreground**: `#9c9689` | **Background**: `#f7f6f3` | **Contrast Ratio**: 2.72
- **Muncul di halaman**:
  - Karyawan - Arsip (`/employees/archive`)
    - `td`
  - Komponen Gaji (`/payroll/salary-components`)
    - `.border-t:nth-child(1) > .text-left:nth-child(6) > .text-neutral-400`
    - `.border-t:nth-child(3) > .text-left:nth-child(6) > .text-neutral-400`
    - `.border-t:nth-child(4) > .text-left:nth-child(5) > .text-neutral-400`
    - `.border-t:nth-child(4) > .text-left:nth-child(6) > .text-neutral-400`
    - `.border-t:nth-child(5) > .text-left:nth-child(6) > .text-neutral-400`
    - `.border-t:nth-child(6) > .text-left:nth-child(5) > .text-neutral-400`
    - `.border-t:nth-child(6) > .text-left:nth-child(6) > .text-neutral-400`
    - `.border-t:nth-child(7) > .text-left:nth-child(5) > .text-neutral-400`
    - `.border-t:nth-child(7) > .text-left:nth-child(6) > .text-neutral-400`
    - `.border-t:nth-child(8) > .text-left:nth-child(5) > .text-neutral-400`
    - `.border-t:nth-child(8) > .text-left:nth-child(6) > .text-neutral-400`
    - `.border-t:nth-child(9) > .text-left:nth-child(5) > .text-neutral-400`
    - `.border-t:nth-child(9) > .text-left:nth-child(6) > .text-neutral-400`
    - `.border-t:nth-child(10) > .text-left:nth-child(5) > .text-neutral-400`
    - `.border-t:nth-child(10) > .text-left:nth-child(6) > .text-neutral-400`
    - `.border-t:nth-child(11) > .text-left:nth-child(5) > .text-neutral-400`
    - `.border-t:nth-child(11) > .text-left:nth-child(6) > .text-neutral-400`
    - `.border-t:nth-child(12) > .text-left:nth-child(5) > .text-neutral-400`
    - `.border-t:nth-child(12) > .text-left:nth-child(6) > .text-neutral-400`
    - `.border-t:nth-child(13) > .text-left:nth-child(5) > .text-neutral-400`
    - `.border-t:nth-child(13) > .text-left:nth-child(6) > .text-neutral-400`

### 2. `color-contrast` - 8 kemunculan
...
- **Muncul di halaman**:
  - Audit Log - List (`/audit-log`)
    - `.cursor-pointer.focus\:bg-neutral-50:nth-child(4) > .text-left:nth-child(3) > .bg-status-submitted\/10.text-status-submitted.px-2`
    ...
    - `.cursor-pointer.focus\:bg-neutral-50:nth-child(12) > .text-left:nth-child(3) > .bg-status-submitted\/10.text-status-submitted.px-2`
    - `.cursor-pointer.focus\:bg-neutral-50:nth-child(13) > .text-left:nth-child(3) > .bg-status-submitted\/10.text-status-submitted.px-2`

### 4. `color-contrast` - 2 kemunculan

- **Deskripsi**: Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Impact**: serious
- **Referensi**: https://dequeuniversity.com/rules/axe/4.13/color-contrast?application=playwright
- **Foreground**: `#9c9689` | **Background**: `#ffffff` | **Contrast Ratio**: 2.94
- **Muncul di halaman**:
  - Lokasi Kantor - Modal Edit (Tab Info) (`/office-locations`)
    - `.border-transparent`
  - Lokasi Kantor - Modal Edit (Tab Supervisor) (`/office-locations`)
    - `.border-transparent`

### 5. `color-contrast` - 1 kemunculan

- **Deskripsi**: Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Impact**: serious
- **Referensi**: https://dequeuniversity.com/rules/axe/4.13/color-contrast?application=playwright
- **Foreground**: `#cce1ff` | **Background**: `#0066ff` | **Contrast Ratio**: 3.63
- **Muncul di halaman**:
  - Login (`/login`)
    - `p`

### 6. `color-contrast` - 1 kemunculan
